...
return [
     ...
     */
    'description' => 'Esta é a documentação da API gerada por este sistema, as informações aqui providas são suficientes para o completo uso do sistema',
...
Todos os campos retornados nas consultas são pesquisáveis, assim não se faz necessários incluir qualquer informação sobre eles em cada endpoint.
