...
return [
    ...
    */
    ...
    'remove' => [
        ...
        NunoMaduro\PhpInsights\Domain\Insights\Composer\ComposerMustContainName::class,
    ...
    'config' => [
        ...
        LineLengthSniff::class => [
            ...
            'ignoreComments' => true,
            'exclude' => [
                'app/Services/BcbCurrencyValueService.php'
            ]
        ],
        ...
        SlevomatCodingStandard\Sniffs\Functions\UnusedParameterSniff::class => [
            'exclude' => [
                ...
                'app/Repositories/AclPermissionRepository.php',
            ]
        ],
        \PhpCsFixer\Fixer\Phpdoc\AlignMultilineCommentFixer::class => [
            'exclude' => [
                'app/Models/PersonInvoiceSetting.php',
                'app/Models/DfeDestined.php'
            ]
        ],
